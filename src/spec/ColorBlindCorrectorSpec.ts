...
describe('A ColorBlindCorrector', () => {
  ...
  beforeEach(() => {
    ...
    bg = new ex.Texture(
      'base/src/spec/images/ColorBlindCorrectorSpec/actor.png',
      true
    );
  ...
  it('is normal', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/normal.png'
      ).then(([canvas, image]) => {
  ...
  it('corrects deuteranopia', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/deuteranope_correct.png'
      ).then(([canvas, image]) => {
        expect(canvas).toEqualImage(image);
        done();
      });
  ...
  it('simulates deuteranopia', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/deuteranope_simulate.png'
      ).then(([canvas, image]) => {
        expect(canvas).toEqualImage(image);
        done();
      });
  ...
  it('corrects protanopia', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/protanope_correct.png'
      ).then(([canvas, image]) => {
        expect(canvas).toEqualImage(image);
        done();
      });
  ...
  it('simulates protanopia', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/protanope_simulate.png'
      ).then(([canvas, image]) => {
        expect(canvas).toEqualImage(image);
        done();
      });
  ...
  it('corrects tritanopia', (done) => {
    ...
    engine.once('postdraw', (ev: ex.PostDrawEvent) => {
      ensureImagesLoaded(
        engine.canvas,
        'src/spec/images/ColorBlindCorrectorSpec/tritanope_correct.png'
      ).then(([canvas, image]) => {
        expect(canvas).toEqualImage(image);
        done();
      });
